...
def build_presentation():
    # Load storyboard
    with open(r"D:/L3/Individual_project/AI_Pedia_Local/data/generated_code/run_e693d537aeb345cf9e584f5876a4fd1a/storyboard.json", "r", encoding="utf-8") as f:
            ...
            if visual_assets:
                ...
                if isinstance(asset, str):
                    ...
                    if os.path.exists(asset):
                        ...
                        # It might be a relative path, so we'll treat it as a code snippet
                        pass
                        
                elif isinstance(asset, dict) and asset.get("type") == "code_snippet":
                    # Generate code snippet image
                    code = asset.get("code", "")
                    img_path = r"D:/L3/Individual_project/AI_Pedia_Local/data/generated_code/run_e693d537aeb345cf9e584f5876a4fd1a/assets/generated_code_{}.png".format(slide_idx)
    ...
    # Save presentation
    output_path = r"D:/L3/Individual_project/AI_Pedia_Local/data/slides/lesson_1768044762.pptx"
