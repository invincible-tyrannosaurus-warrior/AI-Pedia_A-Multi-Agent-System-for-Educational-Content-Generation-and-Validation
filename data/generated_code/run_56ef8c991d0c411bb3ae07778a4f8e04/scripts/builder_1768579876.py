...
def build_presentation():
    # Load storyboard
    with open(r"D:/L3/Individual_project/AI_Pedia_Local/archive/data/generated_code/run_56ef8c991d0c411bb3ae07778a4f8e04/storyboard.json", "r", encoding="utf-8") as f:
        ...
        if layout_idx == 5:  # Content Slide (1 Column)
            ...
            if visual_assets:
                ...
                if isinstance(asset, str):
                    ...
                    code = asset.get("code", "")
                    img_path = f"D:/L3/Individual_project/AI_Pedia_Local/archive/data/generated_code/run_56ef8c991d0c411bb3ae07778a4f8e04/assets/generated_code_{slide_idx}.png"
    ...
    # Save presentation
    output_path = r"D:/L3/Individual_project/AI_Pedia_Local/archive/data/slides/lesson_1768579876.pptx"
