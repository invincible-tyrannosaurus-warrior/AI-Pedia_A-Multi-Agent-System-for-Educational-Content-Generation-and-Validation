...
def build_presentation():
        ...
        if layout_idx == 0:  # Title Slide
            ...
            try:
                ...
                if isinstance(visual_assets, list) and len(visual_assets) > 0:
                    ...
                    # Handle dictionary case (code snippet)
                    if isinstance(asset, dict) and asset.get("type") == "code_snippet":
                        ...
                        font_size = 16
                        # Simple approach - draw text directly
    ...
    # Save presentation
    output_path = r"D:/L3/Individual_project/AI_Pedia_Local/archive/data/slides/lesson_1768106673.pptx"
