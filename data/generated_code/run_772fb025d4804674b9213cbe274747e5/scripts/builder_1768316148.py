...
def build_presentation():
            ...
            try:
                ...
                if isinstance(visual_assets, list) and len(visual_assets) > 0:
                    ...
                    # Case B: Code snippet dictionary
                        ...
                        # Simple monospace font handling (using default)
                        font_size = 16
                        y_text = 10
    ...
    # Save presentation
    output_path = r"D:/L3/Individual_project/AI_Pedia_Local/archive/data/slides/lesson_1768316148.pptx"
