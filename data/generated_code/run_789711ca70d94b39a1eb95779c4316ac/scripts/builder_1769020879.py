...
def build_presentation():
        ...
        if layout_idx == 0:  # Title Slide
            ...
            try:
                ...
                if isinstance(visual_assets, list) and len(visual_assets) > 0:
                    ...
                    # Handle dictionary assets (code snippets)
                    if isinstance(asset, dict) and asset.get("type") == "code_snippet":
                        code = asset.get("code", "")
                        
                        # Create image with code snippet
                        ...
                        # Save image
                        img_path = f"D:/L3/Individual_project/AI_Pedia_Local_stream/data/generated_code/assets/generated_code_{slide_idx}.png"
                        img.save(img_path)
    ...
    # Save presentation
    output_path = r"D:/L3/Individual_project/AI_Pedia_Local_stream/data/generated_code/lesson.pptx"
