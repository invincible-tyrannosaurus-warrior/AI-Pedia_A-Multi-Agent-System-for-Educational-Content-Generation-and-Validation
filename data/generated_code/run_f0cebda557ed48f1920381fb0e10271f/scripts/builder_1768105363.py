                ...
                if asset:
                    try:
                        ...
                        # Case B: Dictionary with code snippet
                            ...
                            # Simple monospace font drawing (in practice you'd want a better solution)
                            font_size = 14
                            y = 10
                        ...
                        print(f"Error processing visual asset for slide {slide_idx}: {e}")

    # Save presentation
    output_path = r"D:/L3/Individual_project/AI_Pedia_Local/archive/data/slides/lesson_1768105363.pptx"
